...
#
# Usage example:
# <mappingstatus lat=51.485 lon=-0.15 z=11 w=300 h=200 layer=osmarender></mappingstatus> 
#
...
if( defined( 'MEDIAWIKI' ) ) {
	...
	$wgExtensionCredits['parserhook'][] = array(
		...
		'description'    => 'Allows the use of the &lt;mappingstatus&gt; tag to display an OpenLayers slippy map. Maps are from [http://openstreetmap.org openstreetmap.org]',
